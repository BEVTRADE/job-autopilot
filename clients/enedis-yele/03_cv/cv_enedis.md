% HAKIM AREZKI, PhD
% ARCHITECTE IA GÉNÉRATIVE & LEAD TECHNIQUE — LLM OPEN SOURCE ON-PREMISE, RAG, AGENTS ET ADOPTION
...
Intervient autant sur la construction que sur l'appropriation : mutualisation des paramétrages et des System Prompts entre équipes, formations de prise en main opérationnelle, animation de référents techniques, référencement et documentation des cas d'usage pour la conformité, et coordination avec les cellules IA transverses. Documentation, modularité et réversibilité systématiques : les solutions livrées sont conçues pour être reprises en exploitation par les équipes internes.
